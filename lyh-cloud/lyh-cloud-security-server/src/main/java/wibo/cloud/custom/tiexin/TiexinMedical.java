...
public class TiexinMedical {
    ...
    private static String XXXregisterData1 = "{\"waterId\":\"562332384\",\"waitingInfor\":\"09:15-09:30\",\"store\":\"\",\"serialNo\":\"73\",\"memberSn\":\"48647895\",\"memberName\":\"李元浩\",\"memberPhone\":\"15720786592\",\"memberAddress\":\"\",\"memberBirthday\":\"1997-10-25\",\"memberSex\":\"1\",\"memberId\":\"48647895\",\"othercard\":\"\",\"guardianmembersn\":\"\",\"identitytype\":\"1\",\"memberZhengjianid\":\"321***********2718\",\"memberIdcard\":\"321***********2718\",\"accManageGoodSn\":null,\"regpaytype\":\"\",\"cliniccard\":\"\",\"applyNo\":\"\",\"mobile\":\"15720786592\",\"doctorSn\":\"711066755\",\"hosDeptId\":\"7208868\",\"hosDeptName\":\"预防接种门诊\",\"hospitalId\":\"1091777\",\"hospitalName\":\"铁心桥社区卫生服务中心\",\"doctorService_gh\":\"2\",\"doctorUid\":\"710741742\",\"doctorName\":\"预防接种医生\",\"doctorPic\":\"\",\"doctorClinicName\":\"医师\",\"GH_HosProId\":\"10\",\"GH_HosProName\":\"江苏\",\"GH_HosCityId\":\"77\",\"GH_HosCityName\":\"南京\",\"registerDate\":\"2021-01-15\",\"timeId\":1,\"arrangeId\":138147885,\"ghAmount\":0,\"securityDeposit\":0,\"ghfeeway\":0,\"ModeId\":0,\"GhFee\":0,\"AllFee\":0,\"availablenum\":56,\"UnOpened\":false,\"FHTimes\":\"08:00\",\"FHDays\":\"7\",\"accountSn\":123502673,\"cardNumber\":\"2053501731\",\"loginId\":\"off6tsyP_O9BBJfSUB65bei27quY\",\"channelId\":\"1000031\",\"utm_source\":\"0.0.h.1026.bus010.0__0.0.h.1026.bus010.0\",\"doctorOfficeName\":\"\"}\n";

    private static String XXXregisterData2 = "[{\"keyValue\":\"\",\"keyName\":\"name\"},{\"keyValue\":\"\",\"keyName\":\"ClinicCard\"},{\"keyValue\":\"321***********2718\",\"keyName\":\"CardNo\"},{\"keyValue\":\"1\",\"keyName\":\"sex\"},{\"keyValue\":\"15720786592\",\"keyName\":\"mobile\"},{\"keyValue\":\"1\",\"keyName\":\"cardtype\"},{\"keyValue\":\"56471\",\"keyName\":\"cmb_disease\"},{\"keyValue\":\"56471\",\"keyName\":\"cmb_disease\"},{\"keyValue\":\"预防接种\",\"keyName\":\"cmb_diseaseName\"}]\n";

    private static String XXXcookie = "_YyghSysTrackUUID=11101532805; jkzlAn_uuid=5E63FBD0-8F42-48C0-BECB-9ECFDA83D192; jkzlAn_channelid=1000031; jkzlAn_userid=123502673; jkzlAn_p=-1; jkzlAn_c=-1; YiHu_OpenId=eyJPcGVuSUQiOiJvZmY2dHN5UF9POUJCSmZTVUI2NWJlaTI3cXVZIiwiU2VjU3RyIjoiQzBGOTI1REU5M0VEMDM2RDYyRUZGNUFFMTEwQzdENDEifQ%3D%3D; logintype=62; loginprovinceid=0; logincityid=0; loginid=off6tsyP_O9BBJfSUB65bei27quY; OpenID=off6tsyP_O9BBJfSUB65bei27quY; BaseDoctorUid=0; BaseUserType=0; LoginChannel=1000031; TOKEN_ED7F42D2E058C2DEBCFC19C399CAFFE9=D880E13A3486490289310A9608505645; jkzlAn_sid=778B30A4-9002-4236-95DE-740515449237; YiHu_UserJosn=eyJBY2NvdW50U24iOjEyMzUwMjY3MywiTG9naW5JZCI6Im9mZjZ0c3lQX085QkJKZlNVQjY1YmVpMjdxdVkiLCJTZWNTdHIiOiJDNDEzMUY1ODBDNEQ3QkI0NTdCOTU0RTlERTlGQTY2MCIsIlVzZXJOYW1lIjoiIiwiQ2FyZE51bWJlciI6IjIwNTM1MDE3MzEiLCJQIjoiVUMifQ%3d%3d; jkzlAn_utm_source=0.0.h.1026.bus010.0__0.0.h.1026.bus010.0; jkzlAn_ct=1610441266520";


    public static void start() {

        DoctorRegOrder doctorRegOrder = JSONObject.parseObject(XXXregisterData1, DoctorRegOrder.class);
        ...
        arrangeMap.put("doctorSn", "711066755"); // TODO 711071506
        ...
        registerRequest.header("Cookie", XXXcookie);
        Boolean isEnd = true;
        ...
        while (isEnd) {
            ...
            if (CollUtil.isNotEmpty(Result)) {
                ArrangeResult result = Result.get(Result.size() - 1); // TODO
                if (!result.getRegisterdate().equals("2021-01-20")) { // TODO
                    continue;  // TODO
                }  // TODO
                if (result.getAvailablenum().compareTo(0) > 0) {
                    ...
                    if (ObjectUtil.isNotNull(timeBean) && CollUtil.isNotEmpty(timeBeanList = timeBean.getResult())) {
                        ...
                        */
                        ...
                        registerMap.put("ghFormCon", XXXregisterData2);
